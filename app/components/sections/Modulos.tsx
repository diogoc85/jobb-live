...
export default function Modulos() {
  ...
  return (
    <section className="modulos w-full relative overflow-hidden py-16 md:py-24 bg-neutral-50">
      <div className="mx-auto w-full max-w-7xl px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="max-w-4xl mx-auto text-center mb-12 md:mb-16 animate-fade-up">
          <p className="text-overline text-primary-500 font-regular tracking-widest uppercase mb-4 text-pretty">
            Nossos Módulos
          </p>
          <h2 className="text-pretty leading-tight tracking-tightest mb-6 font-display text-foreground">
          ...
          <p className="text-heading-6 text-foreground/70 max-w-3xl mx-auto text-pretty">
            Sem planilhas, sem informações perdidas, tudo centralizado.
          </p>
        </div>

        {/* Card Principal de Gestão de Projetos (Fundo Escuro com Imagem do Sistema) */}
        <div className="relative w-full overflow-hidden bg-secondary-900 text-white rounded-none p-6 md:p-12 lg:p-16 mb-16 animate-fade-up duration-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-center relative z-10">
            ...
            <div className="lg:col-span-5 flex flex-col justify-center">
              ...
              <p className="text-heading-6 text-white/80 leading-relaxed text-pretty">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 lg:gap-8">
          ...
          <div className="flex flex-col md:px-4 lg:px-8 border-b md:border-b-0 md:border-r border-foreground/10 pb-8 md:pb-0 last:border-0 last:pb-0 animate-fade-up delay-1">
            {/* Ícone */}
            ...
            {/* Título */}
            <h4 className="text-heading-5 font-display text-foreground mb-6 text-pretty">
          ...
          <div className="flex flex-col md:px-4 lg:px-8 border-b md:border-b-0 md:border-r border-foreground/10 pb-8 md:pb-0 last:border-0 last:pb-0 animate-fade-up delay-2">
            {/* Ícone */}
            <div className="text-primary-500 mb-6">
              <Bank size={32} />
            </div>
          ...
          <div className="flex flex-col md:px-4 lg:px-8 pb-8 md:pb-0 last:border-0 last:pb-0 animate-fade-up delay-3">
            {/* Ícone */}
            <div className="text-primary-500 mb-6">
