...
export default function Indicado() {
  ...
  return (
    <section className="indicado w-full relative overflow-hidden py-16 md:py-24 bg-neutral-50">
      <div className="mx-auto w-full max-w-7xl px-4 md:px-6 lg:px-8 relative z-10">

        {/* Bloco de Cabeçalho Centralizado */}
        <div className="max-w-full mx-auto text-center mb-12 md:mb-16 animate-fade-up">
        ...
        {/* Link / CTA Inferior */}
        <div className="mt-12 md:mt-16 text-center animate-fade-up delay-4">
