...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-background overflow-hidden relative">
      ...
      {/* Área de Links */}
      <div className="mx-auto w-full max-w-7xl px-4 md:px-6 lg:px-8 py-6 relative z-10">
      ...
      {/* Copyright */}
      <div className="mx-auto w-full max-w-7xl px-4 md:px-6 lg:px-8 py-4 relative z-10 text-center md:text-left">
